    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-[#111111] border border-gray-800/50 rounded-lg p-8 max-w-md w-full mx-4">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={onClose}
            className="w-full bg-transparent border border-gray-700 text-gray-300 hover:bg-gray-800/50 font-medium py-3 px-6 rounded-lg text-sm transition-all duration-200"
          >
            Cancel
          </button>
        </div>
